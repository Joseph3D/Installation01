...
public class vp_FPWeaponThrower : vp_WeaponThrower
{
	...
	protected virtual void RewindAnimation()
	{
		...
		if(FPWeapon.WeaponModel.animation == null)
			return;
		...
		FPWeapon.WeaponModel.animation[FPWeaponShooter.AnimationFire.name].time = 0.0f;

		FPWeapon.WeaponModel.animation.Play();
		FPWeapon.WeaponModel.animation.Sample();
		FPWeapon.WeaponModel.animation.Stop();
